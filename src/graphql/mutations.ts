...
export const createPlayerGame = /* GraphQL */ `
  mutation CreatePlayerGame($input: CreatePlayerGameInput!, $condition: ModelPlayerGameConditionInput) {
...
export const updatePlayerGame = /* GraphQL */ `
  mutation UpdatePlayerGame($input: UpdatePlayerGameInput!, $condition: ModelPlayerGameConditionInput) {
...
export const deletePlayerGame = /* GraphQL */ `
  mutation DeletePlayerGame($input: DeletePlayerGameInput!, $condition: ModelPlayerGameConditionInput) {
